...
const config = {
  ...
  SP_OFERTAS: process.env.SP_OFERTAS_ADD_UPD,
  SP_OFERTAS_DEL: process.env.SP_OFERTAS_DEL,
  SP_PRODUCTOSOFERTA: process.env.SP_PRODUCTOSOFERTA_ADD,
  SP_CAMBIAR_ESTADO_OFERTAS:process.env.SP_SWITCH_ACTIVE_OFERTAS,
  ...
  TABLE_OFERTAS: process.env.TABLE_OFERTAS,
  TABLE_PRODUCTOSOFERTAS: process.env.TABLE_PRODUCTOS_OFERTAS,
